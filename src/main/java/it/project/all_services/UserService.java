...
public class UserService {
	...
	private UserImp claudio = new UserImp("Claudio", "Licheri", "14/12/1995", null, null);
	private UserImp elois = new UserImp("Elois", "Mandotti", "10/09/1998", null, null);
	private UserImp gianluca = new UserImp("Gianluca", "Gallone", "17/04/1992", null, null);
	private UserImp emanuel = new UserImp("Emanuel", "Tancau", "07/11/1998", null, null);
	private UserImp massimiliano = new UserImp("Massimiliano", "Zingali", "14/05/1985", null, null);
